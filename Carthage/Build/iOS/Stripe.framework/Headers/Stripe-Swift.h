...
@interface STPError (SWIFT_EXTENSION(Stripe))
...
@class STPPaymentMethodWeChatPay;
...
/// If this is a WeChat Pay PaymentMethod (i.e. <code>self.type == STPPaymentMethodTypeWeChatPay</code>), this contains additional details.
@property (nonatomic, readonly, strong) STPPaymentMethodWeChatPay * _Nullable weChatPay;
...
@class STPPaymentMethodWeChatPayParams;
...
@property (nonatomic, strong) STPPaymentMethodWeChatPayParams * _Nullable weChatPay;
...
/// \param weChatPay An object containing additional WeChat Pay details.
///
/// \param billingDetails An object containing the user’s billing details.
///
/// \param metadata Additional information to attach to the PaymentMethod.
///
- (nonnull instancetype)initWithWeChatPay:(STPPaymentMethodWeChatPayParams * _Nonnull)weChatPay billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)metadata;
...
/// \param metadata Additional information to attach to the PaymentMethod.
///
+ (STPPaymentMethodParams * _Nonnull)paramsWithWeChatPay:(STPPaymentMethodWeChatPayParams * _Nonnull)weChatPay billingDetails:(STPPaymentMethodBillingDetails * _Nullable)billingDetails metadata:(NSDictionary<NSString *, NSString *> * _Nullable)metadata SWIFT_WARN_UNUSED_RESULT;
@end
...
/// An unknown type.
  STPPaymentMethodTypeUnknown = 21,
};
...
SWIFT_CLASS("_TtC6Stripe25STPPaymentMethodWeChatPay")
@interface STPPaymentMethodWeChatPay : NSObject <STPAPIResponseDecodable>
@property (nonatomic, readonly, copy) NSDictionary * _Nonnull allResponseFields;
/// :nodoc:
@property (nonatomic, readonly, copy) NSString * _Nonnull description;
+ (nullable instancetype)decodedObjectFromAPIResponse:(NSDictionary * _Nullable)response SWIFT_WARN_UNUSED_RESULT;
...
SWIFT_CLASS("_TtC6Stripe31STPPaymentMethodWeChatPayParams")
@interface STPPaymentMethodWeChatPayParams : NSObject <STPFormEncodable>
@property (nonatomic, copy) NSDictionary * _Nonnull additionalAPIParameters;
+ (NSString * _Nullable)rootObjectName SWIFT_WARN_UNUSED_RESULT;
+ (NSDictionary<NSString *, NSString *> * _Nonnull)propertyNamesToFormFieldNamesMapping SWIFT_WARN_UNUSED_RESULT;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
